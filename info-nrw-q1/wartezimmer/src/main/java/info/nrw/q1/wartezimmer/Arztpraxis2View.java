 ...
 * 
 */
public class Arztpraxis2View extends JFrame {
  ...
  private JButton btnAkten;
  
  private ArztpraxisMitBDController kenntArztpraxisController;
  private JTextField tSprechzimmer;


  
  public Arztpraxis2View() {
    ...
    btnPatientAnmelden.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent arg0) {
        if (!(tName.getText().equals("") || tKasse.getText().equals(""))){
          ...
          JOptionPane.showMessageDialog(Arztpraxis2View.this, "Bitte Namen und Kasse angeben");
        }
      }
    });
    ...
    btnAkten = new JButton("Alle Akten durchgehen");
    btnAkten.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {        
          kenntArztpraxisController.alleAktendurchgehen();       
      }
    });
    btnAkten.setBounds(415, 273, 160, 23);
    contentPane.add(btnAkten);
  }
  
  public void setzeArztpraxisController(
      ArztpraxisMitBDController kenntArztpraxisController) {
